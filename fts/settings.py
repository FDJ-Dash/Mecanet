...
ALLOWED_HOSTS = ['127.0.0.1', '192.168.1.10', 'localhost', 'mydjango.com']
...
INSTALLED_APPS = [
    ...
    'polls.apps.PollsConfig', # Polls app Fer
    'mecanicos.apps.MecanicosConfig', # Mecanicos app Fer
    'talleres.apps.TalleresConfig', # Talleres app Fer
    'comentarios.apps.ComentariosConfig', # Comentarios mecanet app Fer
    'social_django', #Social auth django
...
# Definir las variables de entorno para que funcione
