...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        """
        Questions with a pub_date in the past without choice. 
        ...
        print("Ok, no choices created for current question")  
            
    def test_index_view_with_a_past_question2(self):
        """
        Questions with a pub_date in the past should be displayed on the
        index page.
        """
        q = create_question_with_choice(question_text="Past question.", days=-30)
        response = self.client.get(reverse('polls:index'))
        # question with choices created
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
